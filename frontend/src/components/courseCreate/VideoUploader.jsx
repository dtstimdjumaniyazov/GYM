  ...
  return (
    <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-lg px-3 py-2">
      ...
      {onTitleChange ? (
        ...
        <span className="text-gray-800 text-sm truncate flex-1">{uploadedVideo.title}</span>
      )}

      {onRemove && (
        <button type="button" onClick={onRemove} className="text-gray-300 hover:text-red-500 transition-colors ml-1 shrink-0">
